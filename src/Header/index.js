...
const Header = ({cartItems}) => {
  ...
  return (
    <header className="p-4 d-flex flex-row align-items-center navbar-header">
      <div className="header">
        <h1 className="m-0 logo-font">UNI Resto Cafe</h1>
        <div className="my-orders-cart-alignment">
